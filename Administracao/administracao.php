...
$queryAcervo="select nome_pagina,pasta from grupos_sub_paginas gp inner join tabelas_sistema ts on gp.id_tabela=ts.id_tabela where gp.id_perfil=4 and gp.id_grupo in (9,10)";
