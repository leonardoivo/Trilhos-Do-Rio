...
<html>
  <head>
    ...
    <script type="text/javascript"
      src="http://maps.googleapis.com/maps/api/js?key=AIzaSyA72NcoZXPMcYPisPwtck2Mwr_ocPMB8ZY">
    </script>
    <script>
    //Standard Google Maps API code with project specific values
    function initialize() {
      var middleEarth = new google.maps.LatLng(52.01254, 8.2133); // Definindo centro de mapa
      var mapOptions = {
        zoom: 5,
        center: middleEarth,
      ...
      var map = new google.maps.Map(document.getElementById('map-canvas'), mapOptions); //criando mapa inicial

      //The Polyline coordinates. Lots and Lots of them.
      var routeCoordinates = [                                  //Criando rotas de coordenadas para as linhas
      ...
      var routePath = new google.maps.Polyline({
        path: routeCoordinates, //Passando as coordenadas para geração das linhas das mesmas.
        strokeColor: '#FF0000',
        strokeOpacity: 1.0,
        strokeWeight: 2
      });
      ...
      document.getElementById("distanceTravelled").innerHTML = Math.round(routePath.inKm())+' km';  // Fazendo o calculo de distância percorrida

      //Add the Polyline to the map canvas
      routePath.setMap(map); // Dando vida as linhas.

      //variables and list for the marker's to link back to the travel blog
      var tagURL = 'http://meandmypack.wordpress.com/tag/'; 

      var mainCities = [    // Aqui só serve para gerar os pontos das partidas!!
      ...
      //Stick those markers into the map canvas   Esse aqui monta os pontos na tela
   ...
   // The polyline distance code from https://groups.google.com/forum/#!topic/google-maps-js-api-v3/Op87g7lBotc
    // passando os calculos de kilometragem para o google maps calcular a kilometragem a partir das polilinhas
