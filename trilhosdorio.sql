...
--
-- Host: localhost
-- Generation Time: 03-Ago-2018 às 21:25
...
INSERT INTO `acervo` (`id_acervo`, `nome_acervo`, `id_patrimonio`, `Descricao`, `DataDeCriacao`) VALUES
(1, 'teste', NULL, 'teste', '2018-08-03'),
(2, 'fdfdf', NULL, 'eweew', '2018-08-03');
...
CREATE TABLE `audios` (
  ...
  `data_de_gravacao` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `documentos` (`id_documento`, `nome_documento`, `tipo_documento`, `descricao`, `id_acervo`, `formato`, `dataDeCadastramento`) VALUES
(0, '', NULL, '', NULL, NULL, '1970-01-01');
...
--
ALTER TABLE `acervo`
  MODIFY `id_acervo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
